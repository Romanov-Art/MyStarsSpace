...
const STAR_NAMES_LOCALIZED: Record<string, Record<string, string>> = {
  ...
  ja: {
    ...
    Pollux: 'ポルックス', Fomalhaut: 'フォーマルハウト', Deneb: 'デネブ', Regulus: 'レグルス',
    Polaris: 'ポラリス',
  },
  ko: {
    ...
    Fomalhaut: '포말하우트', Deneb: '데네브', Regulus: '레굴루스', Polaris: '폴라리스',
  },
  zh: {
    ...
    Fomalhaut: '北落师门', Deneb: '天津四', Regulus: '轩辕十四', Polaris: '北极星',
  },
  ar: {
    Sirius: 'الشعرى', Canopus: 'سهيل', Arcturus: 'السماك', Vega: 'النسر الواقع',
    Capella: 'العيوق', Rigel: 'رجل الجبار', Procyon: 'الشعرى الشامية',
    Betelgeuse: 'يد الجوزاء', Altair: 'النسر الطائر', Aldebaran: 'الدبران',
    Antares: 'قلب العقرب', Spica: 'السماك الأعزل', Fomalhaut: 'فم الحوت',
    Deneb: 'ذنب الدجاجة', Regulus: 'قلب الأسد', Polaris: 'الجدي',
  },
  hi: {
    Sirius: 'व्याध', Canopus: 'अगस्त्य', Arcturus: 'स्वाती', Vega: 'अभिजित',
    Capella: 'ब्रह्महृदय', Rigel: 'राजन्य', Procyon: 'प्रोसियॉन',
    Betelgeuse: 'आर्द्रा', Altair: 'श्रवण', Aldebaran: 'रोहिणी',
    Antares: 'ज्येष्ठा', Spica: 'चित्रा', Fomalhaut: 'फ़ोमलहौत',
    Deneb: 'डेनेब', Regulus: 'मघा', Polaris: 'ध्रुव',
  },
};
